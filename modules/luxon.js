...
class Zone {
  ...
  /**
    ...
    * @abstract
    * @param {number} _ts - Epoch milliseconds for which to get the name
    * @param {Object} _opts - Options to affect the format
    * @param {string} opts.format - What style of offset to return. Accepts 'long' or 'short'.
    * @param {string} opts.locale - What locale to return the offset name in.
    * @return {string}
    */
  offsetName(_ts, _opts) {
    throw new ZoneIsAbstractError();
  }
  ...
  /**
    ...
    * @abstract
    * @param {number} _ts - Epoch milliseconds for which to compute the offset
    * @return {number}
    */
  offset(_ts) {
    throw new ZoneIsAbstractError();
  ...
  /**
    ...
    * @abstract
    * @param {Zone} _otherZone - the zone to compare
    * @return {boolean}
    */
  equals(_otherZone) {
    throw new ZoneIsAbstractError();
...
function tokenForPart(part, _locale, formatOpts) {
